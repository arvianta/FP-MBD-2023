                ...
                <div class="card-body">
                    <form action="{{ route('admin.cars.update', $car->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_mobil" class="form-control" value="{{old('nama-mobil, $car->nama_mobil') }}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="deskripsi" id="deskripsi" class="form-control" cols="30" rows="10"> {{old('deskripsi', $car->deskripsi) }}</textarea>
                        </div>
                        <div class="form-group">
